...
namespace OurSonic
{
    public partial class SonicManager
    {
        ...
        [IntrinsicProperty]
        protected List<LevelObjectInfo> InFocusObjects { get; set; }
        [IntrinsicProperty]
        ...
        private void tickObjects()
        {
            ...
            foreach (LevelObjectInfo obj in SonicLevel.Objects)
            {
                ...
                switch (CurrentGameState)
                {
                    ...
                    case GameState.Editing:
                        if (BigWindowLocation.Intersects(r))
                            GoodRing.Draw(canvas, r.Negate(WindowLocation), Scale);
                        break;
                }
