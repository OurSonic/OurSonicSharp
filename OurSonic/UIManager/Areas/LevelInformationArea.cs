...
namespace OurSonic.UIManager.Areas
{
    public class LevelInformationArea
    {
        public LevelInformationArea(UIManager manager)
        {
            ...
            levelInformation.AddControl(new TextArea(30, 52, ( (Func<string>) ( () => UIManager.CurLevelName ) ))
                                        {Font = UIManager.TextFont, Color = "black"});
            ...
            var loadLevel = (Action<string>) ( name => {
                                                   ...
                                                   SonicEngine.Instance.client.On<DataObject<string>>("LoadLevel.Response", (data) => {
                                                                                                                                var lvl = data.Data;
            ...
            SonicEngine.Instance.client.On<DataObject<string[]>>("GetLevels.Response", data => {
