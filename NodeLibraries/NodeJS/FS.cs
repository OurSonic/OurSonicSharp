...
namespace NodeJSLibrary
{
    ...
    public class FS : NodeModule
    {
        ...
        public string ReadFileSync(string s, string encoding) { return default(string); }
        public string RenameSync(string oldPath, string newPath) { return default(string); }
        public string TruncateSync(string fd, int len) { return default(string); }
        public string MkdirSync(string path, string mode) { return default(string); }
        public string[] ReaddirSync(string path) { return default(string[]); }
        public string CloseSync(string fd) { return default(string); }
        public string OpenSync(string path, string flags, string mode) { return default(string); }
        public string WriteSync(string fd, string buffer, int offset, int length, int position) { return default(string); }
        public string ReadSync(string fd, string buffer, int offset, int length, int position) { return default(string); }
        public string WriteFileSync(string filename, string data, string encoding) { return default(string); }
        public string WriteFileSync(string filename, string data) { return default(string); }
        public string AppendFileSync(string filename, string data, string encoding) { return default(string);; }
        public bool ExistsSync(string path) { return default(bool); }
